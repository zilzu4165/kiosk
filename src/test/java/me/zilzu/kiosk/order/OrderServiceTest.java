...
class OrderServiceTest {
    ...
    public void doOrder_기본_테스트() {
        ...
        orderSaveRequest.setOrderId(1L);
        orderSaveRequest.setTotalPrice(100);
        orderSaveRequest.setIsTakeOut(true);
        orderSaveRequest.setPaymentMethod("CARD");
        orderSaveRequest.setUserId(1L);
        orderSaveRequest.setStoreId(1L);
