package me.zilzu.kiosk.action.aop;
...
public class BlogAop {
    ...
    @Around("execution(* me.zilzu.kiosk.action.service.BlogService.*(..))")
    ...
    @Around("execution(* me.zilzu.kiosk.action.controller.BlogController.*(..))")
